def get_partition_snapshots_root_path(bucket_name, dataset_name, today_str):
...
def get_partition_snapshot_path(bucket_name, dataset_name, today_str, partition_col, partition_val):
    return get_partition_snapshots_root_path((bucket_name, dataset_name, today_str)) + f"{partition_col}={partition_val}"
...
def get_aggregate_snapshot_path(bucket_name, dataset_name, today_str):
