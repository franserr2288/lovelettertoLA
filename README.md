Dev Notes: 
I have stood up two endpoints to serve the metrics that I find as I ingest each dataset, I need to make a decision on how I want to implement the rest of the pipeline for the larger datasets soon. Will be more work to refactor later
